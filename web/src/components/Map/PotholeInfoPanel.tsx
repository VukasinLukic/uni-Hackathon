...
const PotholeInfoPanel: React.FC<PotholeInfoPanelProps> = ({ pothole, onClose }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Reload potholes from backend to update sidebar
      window.dispatchEvent(new CustomEvent('pothole-updated'));
    ...
    <div className="pothole-info-panel">
      ...
      <div className="info-content">
        ...
        <div className="info-row">
          ...
          <span className="info-value">{pothole.severity}/100</span>
        </div>

        <div className="info-row">
          <span className="info-label">Reports:</span>
          <span className="info-value">{pothole.reports}</span>
        </div>
